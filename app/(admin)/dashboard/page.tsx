...
import { CalendarDays, Users, TrendingUp, AlertCircle, CheckCircle2, Circle } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3" data-testid="kpi-grid">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold" data-testid="kpi-revenue-today">{revenue} KM</p>
          </CardContent>
        </Card>
